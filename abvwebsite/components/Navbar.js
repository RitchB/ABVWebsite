      ...
      <div className="mt-8 flex justify-between">
        <div className="flex gap-8">
          <div className="flex items-center space-x-8">
            <Link href="/">
              <a className="items-center text-5xl text-blue-900 hover:text-blue-700 tracking-tight antialised font-Schoolbell">
                A Beaver&apos;s Adventure
              </a>
            </Link>
          </div>
          <div className="hidden lg:flex items-center space-x-6">
            <Link href="https://objkt.com/collection/KT1GUKaPHrc4T6ZtShKv1zGMiuKLkmFnatpn">
              <a
                target="_blank"
                rel="noreferrer"
            ...
            <Link href="/lore">
              <a className="text-3xl text-red-700 hover:text-red-800 antialised font-PatrickHandSC">
                Lore
              </a>
            </Link>
            <Link href="/about">
